#!/bin/bash
# ====================================================================
# Experiment B: Ratio split (teammate style, 0.70/0.15/0.15)
# Test period ~ Oct 2023 - Sep 2024 (all targets trending up)
# Uses proven graph_diff config with NO enforce_cutoff
# ====================================================================
cd "$(dirname "$0")"
