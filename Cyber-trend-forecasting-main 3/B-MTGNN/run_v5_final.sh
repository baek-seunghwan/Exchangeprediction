#!/bin/bash
# ====================================================================
# PROVEN CONFIG: graph_diff (kr_fx=0.67) + selective val_linear debias
#
# The only change from graph_diff: add val_linear debias for
# us_Trade and jp_fx ONLY (skip kr_fx to preserve kr_fx=0.67)
#
# Expected from POST-HOC analysis:
#   kr_fx:    0.71 (none, preserved)
#   us_Trade: 1.53 (val_linear, improved from 3.32)
#   jp_fx:    1.83 (val_linear, improved from 1.99)
# ====================================================================
cd "$(dirname "$0")"
