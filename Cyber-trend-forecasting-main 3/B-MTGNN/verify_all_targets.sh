#!/bin/bash
# Full verification with ALL targets for seed=37, 5 epochs
cd "$(dirname "$0")"
export MPLBACKEND=Agg
PYTHON="/Users/samrobert/Documents/GitHub/Exchangeprediction/.venv/bin/python"

echo "=== Seed=37, 5 epochs, ALL targets ==="
$PYTHON train_test.py \
  ...
  --seed 37 \
  --eval_last_epoch 1 \
  --save_pred_dir ensemble_runs/seed_37_ep5_verified \
  2>&1 | grep -E "\[Testing\]|eval_last|final test"

echo ""
echo "=== Seed=37, 5 epochs, L1 loss, graph=1 ==="
echo "Expected: kr_fx ~0.37, jp_fx ~1.37, us_Trade ~4.29"
